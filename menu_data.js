...
with ((milonic = new menuname("Pictures"))) {
  ...
  aI(
    "text=My Life Pictures as exe file (12,346,625 bytes);url=Pictures/My Life.exe;"
  );
}
...
with ((milonic = new menuname("Writeups"))) {
  style = menuStyle;
  aI(
    "text=Stanley Skoe Reflections;url=writeups/Stanley Skoe Reflections.pdf;"
  );
  aI(
    "text=Stanley Skoe Berry Picking;url=writeups/Stanley Skoe Berry Picking.pdf;"
  );
  aI(
    "text=Stanley Skoe Sinksholes and Bad Roads;url=writeups/Sinkholes and Bad Roads by Stanley Skoe.pdf;"
  );
  aI(
    "text=Earl Thomas Skoe - Centennial History 1903-2003;url=writeups/Earl Thomas Skoe.pdf;"
  );
  aI(
    "text=Vera Janet Skoe written by Ralph and Kathy Skoe;url=writeups/vera janet skoe.pdf;"
  );
  aI(
    "text=Earl and Vera's 50th Anniversary and other information;url=writeups/earl and vera skoe 50 anniversary.pdf;"
  );
  aI(
    "text=Tribute to my Aunt Emilie;url=writeups/Tribute to Emilie Nov 2006.pdf;"
  );
  aI(
    "text=Bergville School As I Remember It - The download may take a couple of minutes;url=writeups/Bergville School as I remember it.pdf;"
  );
  aI(
    "text=Skoe Update 1980 - The download may take a couple of minutes;url=writeups/Skoe Update 1980.pdf;"
  );
  aI(
    "text=Tribute to Bena Skoe Petzel on 81st Birthday - The download may take a couple of minutes;url=writeups/Tribute to Bena Skoe Petzel on 81st Birthday.docx;"
  );
}
with ((milonic = new menuname("Books"))) {
  style = menuStyle;
  aI("text=Skoe Saga - Bena Skoe;url=Skoe Saga/Skoe Saga.pdf;");
  aI("text=My Life - R.C. Skoe;url=It's my Life Ray Skoe/My Life.pdf;");
}
